...
<div class="row">
    <div class="col s12 m6 push-m3">
        ...
        <form action="../../Config/cliente_config.php" method="POST">
            ...
            <div class="input-field col s12">
            Informe o seu RG:<input type="text" name="rg" placeholder="Informe o seu RG:" />
            </div>
            <div class="input-field col s12">
            Informe o seu E-mail: <input type="email" name="email" placeholder="Informe o seu E-Mail:" />
            </div>
            <div class="input-field col s12">
            Informe o seu Telefone: <input type="text" name="telefone" placeholder="Informe o seu Telefone:" />
            </div>
            <div class="input-field col s12">
