        ...
        <tbody>
          <?php foreach($resultado as $data): ?>
            <tr>
              ...
              <td><a href="edita_fornecedor.php"  class="btn green">Editar</a></td>

              <td><a href="../../Config/fornecedor_config.php" type="delete" class="btn-floating red"><i class="material-icons">delete</td>
            </tr>
          <?php endforeach; ?>
        </tbody>
    </table>
