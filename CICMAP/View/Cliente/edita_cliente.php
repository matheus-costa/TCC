...
$sql = "SELECT * FROM cliente where  " . $_REQUEST['id'] . "";
        ...
        <tbody>
          <?php foreach($resultado as $data): ?>
            <tr>
              ...
              <td><a href="edita_cliente.php"  class="btn green">Voltar</a></td>

              <td><a href="../../Config/cliente_config.php" type="delete" class="btn-floating red"><i class="material-icons">delete</td>
            </tr>
          <?php endforeach; ?>
        </tbody>
    </table>
